...
// console.log(`It would take the vessel ${spacecraftName} ${daysToMars} days to reach Mars.`)
// // Part 3: Create a Function ("getDaysToLocation")
// // Move your output statement from part 2 here. Update the template literal to call
// // the function and print the outputs for a Mars trip and a moon trip.
// console.log(`It would take the vessel ${spacecraftName} ${getDaysToLocation(kilometersToMars)} days to reach Mars.`)
// console.log(`It would take the vessel ${spacecraftName} ${getDaysToLocation(kilometersToTheMoon)} days to reach the Moon.`)
